...
function buildFlowerMSP() {
    var m = parseInt(mField.value);
    var sideLength = parseInt(sideLengthField.value);
    ...
    var msp = new MSP(rhombi, chains, selectedVertex, m, sideLength);
    msps.push(msp);
    selectedMSP = msp;
